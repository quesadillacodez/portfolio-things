// Shared site constants. Item 18: a visitor could not tell whether this site was from
// last week or last year, so the date lives in one place and is rendered in the footer.
export const site = {
