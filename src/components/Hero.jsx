...
const PROOF_IMAGE = '/assets/pulseops-roster.jpeg';
      ...
      <div className="hero-grid">
        <div className="hero-lead">
          ...
          <p className="hero-blurb">
            I&rsquo;m Hadi Qusyairi, a Digital Business and FinTech student building practical
            software and analytics tools, informed by hands-on experience in retail, logistics,
          ...
          <div className="hero-actions">
            <a className="button button-primary" href={`mailto:${EMAIL}?subject=Let%E2%80%99s%20work%20together`}>
              Start a conversation <Icon name="arrow" />
            </a>
            <a className="button button-quiet" href="#work">See the work</a>
        ...
        <div className="hero-proof">
          ...
          <div className="hero-id">
            ...
            <dl className="hero-facts">
              ...
              <div><dt>Studying</dt><dd>Digital Business &amp; FinTech</dd></div>
              <div><dt>Builds</dt><dd>Operational tools &amp; dashboards</dd></div>
            </dl>
          </div>
        </div>
      </div>
