...
const process = [
  { n: '01', title: 'Observe the workflow', body: 'I map who does what, where information changes hands, and which steps create avoidable waiting or errors.' },
  { n: '02', title: 'Model the logic', body: 'I define the data, rules, edge cases, and success criteria before choosing the interface or visualization.' },
  { n: '03', title: 'Build the smallest useful version', body: 'I connect core actions first, then improve feedback, validation, and readability around actual user tasks.' },
  { n: '04', title: 'Test the claim', body: 'I separate measured outcomes from projections, collect feedback, and document assumptions that still need validation.' },
];
      ...
      <main id="main-content">
        ...
        <section className="section work-section" id="work">
          <div className="section-intro">
            <p className="section-label" data-reveal>Selected work · 2024 to 2026</p>
            <SplitHeading
              text="Projects built around"
              emphasis="real decisions."
              reducedMotion={reducedMotion}
            />
            <p data-reveal>Each project starts with an operational question, then turns it into software, analysis, or a clearer workflow.</p>
          </div>
        ...
        <section className="section demo-section" id="try" aria-labelledby="try-heading">
          <div className="demo-inner" data-reveal>
            <div className="demo-copy">
              ...
              <p>
                Every project on this site started as somebody&rsquo;s awkward Tuesday. This is one
                of them, rebuilt small enough to play with in your browser.
              </p>
            </div>
            <RosterDemo />
          </div>
        ...
        <section className="section process-section" id="process">
          <div className="section-intro compact">
            <p className="section-label" data-reveal>How I work</p>
            <SplitHeading
          ...
          <div className="skills-shell">
            <div className="skills-aside" data-reveal>
              ...
              <p className="skills-note">
                Grouped by what they are for rather than by how well I know them — the
                second list is the one worth talking about in person.
              </p>
            </div>
      ...
      <footer id="contact">
        ...
        <div className="footer-bottom">
          ...
          <div>
            ...
            <a href="https://github.com/quesadillacodez" target="_blank" rel="noreferrer">GitHub</a>
