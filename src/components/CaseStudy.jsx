      ...
      <div className="case-inner">
        ...
        <section className="case-block">
          ...
          <ul className="case-constraints">
            {study.constraints.map((line) => <li key={line}>{line}</li>)}
          </ul>
        </section>
        ...
        <section className="case-block case-block-wide">
          ...
          <div className="case-grid">
            {project.visual.images.map((image, index) => (
              ...
              >
                <img src={image.src} alt={image.alt} width="1525" height="948" loading="lazy" decoding="async" />
              </TiltFrame>
            ))}
          </div>
        </section>
            ...
            <div className="case-grid">
              {project.artifacts.map((artifact) => (
                <figure key={artifact.src} className="case-artifact">
                  ...
                  <figcaption><strong>{artifact.label}</strong>{artifact.note}</figcaption>
                </figure>
              ))}
            </div>
          </section>
        ...
        <section className="case-block">
          ...
          <ul className="case-next">
            {study.nextTime.map((line) => <li key={line}>{line}</li>)}
          </ul>
        </section>
